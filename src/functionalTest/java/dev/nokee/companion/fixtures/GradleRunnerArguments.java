...
public class GradleRunnerArguments implements Iterable<String> {
	...
	private GradleRunnerArguments withConfigurationCacheEnabled() {
		return withConfigurationCacheEnabled(UnaryOperator.identity());
	}

	private GradleRunnerArguments withConfigurationCacheEnabled(UnaryOperator<ConfigurationCacheProblems> action) {

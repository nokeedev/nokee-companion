...
class CppDependencyOnGeneratedPublicHeadersSampleTests {
	static ExemplarElement<GradleBuildElement> project;
	@TempDir static Path testDirectory;
	static GradleRunner runner;

	@BeforeAll
	static void setup(@Sample("cpp-dependency-on-generated-public-headers") ExemplarElement<GradleBuildElement> sample) {

...
class CppCompileOptionsPerSourceFilesSampleTests {
	static ExemplarElement<GradleBuildElement> project;
	@TempDir static Path testDirectory;
	static GradleRunner runner;

	@BeforeAll
	static void setup(@Sample("cpp-compile-options-per-source-files") ExemplarElement<GradleBuildElement> sample) {

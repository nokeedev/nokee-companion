...
class CppMultiplePublicHeaderDirectoriesSampleTests {
	static ExemplarElement<GradleBuildElement> project;
	@TempDir static Path testDirectory;
	static GradleRunner runner;

	@BeforeAll
	static void setup(@Sample("cpp-multiple-public-header-directories") ExemplarElement<GradleBuildElement> sample) {

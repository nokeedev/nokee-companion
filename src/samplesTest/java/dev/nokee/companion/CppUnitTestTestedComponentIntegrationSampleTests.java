...
class CppUnitTestTestedComponentIntegrationSampleTests {
	static ExemplarElement<GradleBuildElement> project;
	@TempDir static Path testDirectory;
	static GradleRunner runner;

	@BeforeAll
	static void setup(@Sample("cpp-unit-test-tested-component-integration") ExemplarElement<GradleBuildElement> sample) {

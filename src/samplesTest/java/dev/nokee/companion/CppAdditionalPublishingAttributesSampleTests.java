...
class CppAdditionalPublishingAttributesSampleTests {
	static ExemplarElement<GradleBuildElement> project;
	@TempDir static Path testDirectory;
	static GradleRunner runner;

	@BeforeAll
	static void setup(@Sample("cpp-additional-publishing-attributes") ExemplarElement<GradleBuildElement> sample) {

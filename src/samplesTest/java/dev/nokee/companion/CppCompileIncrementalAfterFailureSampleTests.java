...
class CppCompileIncrementalAfterFailureSampleTests {
	static ExemplarElement<GradleBuildElement> project;
	@TempDir static Path testDirectory;
	static GradleRunner runner;

	@BeforeAll
	static void setup(@Sample("cpp-compile-incremental-after-failure") ExemplarElement<GradleBuildElement> sample) {

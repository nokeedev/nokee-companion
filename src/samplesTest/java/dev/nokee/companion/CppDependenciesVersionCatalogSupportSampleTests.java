...
class CppDependenciesVersionCatalogSupportSampleTests {
	static ExemplarElement<GradleBuildElement> project;
	@TempDir static Path testDirectory;
	static GradleRunner runner;

	@BeforeAll
	static void setup(@Sample("cpp-dependencies-version-catalog-support") ExemplarElement<GradleBuildElement> sample) {
